...
* You can decode transaction script call ([struct](https://developers.diem.org/docs/rustdocs/diem_types/transaction/struct.Script.html)) from script_bytes by BCS deserializer.
