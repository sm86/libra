...
All network communication occurs over LibraNet and any serialization, deserialization and hashing is determined by [BCS](https://developers.diem.org/docs/rustdocs/diem_canonical_serialization/).
