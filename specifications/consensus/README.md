...
All network communication occurs over DiemNet and any serialization, deserialization and hashing is determined by [BCS](https://developers.diem.org/docs/rustdocs/diem_canonical_serialization/).
